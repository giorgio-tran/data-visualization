...
const InfoBox = () => {
    ...
    return (
        <div
            className="mt-12 bg-black/70 backdrop-blur-lg text-white shadow-lg rounded-lg p-4 w-[360px] h-[300px] border border-gray-800 flex flex-col relative">
            <button
            ...
            <div
                className="overflow-y-auto flex-grow scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-800 mb-6 scrollbar-thin">
                {content}
            </div>
